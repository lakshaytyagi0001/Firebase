...
import { StyleSheet, TouchableOpacity, Alert, Picker } from 'react-native';
...
export default class App extends React.Component {
  ...
  async getDonor() {     
        return fetch(`https://fir-e7e39.firebaseio.com/donors.json`)
  ...
  addDonor = (name, mobile, group) => {
    if(this.state.name != null && this.state.mobile != null && this.state.group != null){ 
      fetch('https://fir-e7e39.firebaseio.com/donors.json', {
        method: 'POST',
        headers: {
